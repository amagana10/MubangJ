...
UPDATE EMPLOYEE SET SALARY = 600000 WHERE EMPLOYEE_ID = 3 OR EMPLOYEE_ID = 4;
...
departmentName DEPARTMENT.DEPARTMENT_NAME%TYPE;
checker NUMBER;
...
BEGIN
    ...
    INTO departmentName, checker, avgSalary
    FROM EMPLOYEE e
    INNER JOIN DEPARTMENT d ON e.DEPARTMENT_ID = d.DEPARTMENT_ID
